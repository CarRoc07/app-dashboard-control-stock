    ...
    return (
        <div className='flex flex-row items-center justify-center gap-32 border-b-2 border-t-2 w-full p-2'>
            ...
            <div className='flex items-center gap-3 w-[120px]'>
                <button className='bg-blue-600 text-white py-2 px-3 rounded-lg hover:bg-blue-800' onClick={() => router.push(`/edit/${_id}`)}><RiEdit2Line /></button>
                <button className='bg-red-600 text-white py-2 px-3 rounded-lg hover:bg-red-800' onClick={() => openModal()}><RiDeleteBinLine /></button>
            </div>
        </div>
    )
}
